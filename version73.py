...
class MainUiClass(QtWidgets.QMainWindow, gui.Ui_MainWindow):
    ...
    def record(self):
        ...
        try:
            ...
            return
        try:
            emailSubject = "Cell7 Test Started"
            Emailer().sendmail(emailSubject, record_file_name)
        except:
            self.updateLog("Issue Sending Start Email.")
    ...
    def abort(self):
        ...
        try:
            emailSubject = "Cell7 Test Ended"
            record_file_name = self.fileName.text()
            Emailer().sendmail(emailSubject, record_file_name)
        except:
            self.updateLog("Error Sending Ending Email.")
...
class Emailer:
    def sendmail(self, subject, content):
        recipient = 'michael@msoe.edu'
        smtp_server = 'smtp.gmail.com'  # Email Server (don't change!)
        smtp_port = 587  # Server Port (don't change!)
        gmail_username = 'eeoffpi@gmail.com'
        gmail_password = 'msoe1903'
